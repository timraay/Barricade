...
def upgrade() -> None:
    ...
    op.add_column('communities', sa.Column('confirmations_channel_id', sa.Integer(), nullable=True))
    op.add_column('communities', sa.Column('alerts_channel_id', sa.Integer(), nullable=True))
    op.add_column('communities', sa.Column('alerts_role_id', sa.Integer(), nullable=True))
