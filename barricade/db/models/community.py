...
class Community(ModelBase):
    ...
    confirmations_channel_id: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    alerts_channel_id: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    alerts_role_id: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
